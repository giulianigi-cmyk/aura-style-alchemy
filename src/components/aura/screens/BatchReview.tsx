        ...
        for (const it of res.items) {
          try {
            ...
            built.push({
              ...
              sleeveLength: (it as Record<string, any>).sleeve_length ?? "",
              formality: (it as Record<string, any>).formality ?? null,
              dayEvening: (it as Record<string, any>).day_evening ?? "",
              length: (it as Record<string, any>).length ?? "",
              fit: (it as Record<string, any>).fit ?? "",
              heelHeight: (it as Record<string, any>).heel_height ?? "",
              toeShape: (it as Record<string, any>).toe_shape ?? "",
              closure: (it as Record<string, any>).closure ?? "",
              gender: (it as Record<string, any>).gender ?? "",
              styleTags: (it as Record<string, any>).style_tags ?? [],
              dedupe,
