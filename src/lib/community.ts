        ...
        >
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-widest text-muted-foreground">
              {row.direction === "outgoing" ? t("community.youShared")
                : row.direction === "broadcast" ? (row.shared_by === meId ? t("community.youSharedToFeed") : t("community.sharedToFeed"))
                : t("community.sharedWithYou")}
            </p>
          </div>
        </button>
      </div>
