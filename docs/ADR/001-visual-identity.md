...
```
Filtro attributi (categoria, colore, sottocategoria)
        ↓
Embedding visivo (raffinamento, solo su ciò che passa il filtro)
        ↓
Conferma utente (solo se il risultato resta ambiguo)
```
